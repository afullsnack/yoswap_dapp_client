...
const ReviewOrder: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setTimeout(() => router.push("/sell/approve"), 1000)
    } catch (error: any) {
      ...
      <div className="relative flex w-full flex-col items-center max-sm:mt-10 md:mt-0">
        <div className="flex h-auto rounded-lg bg-[#FFFFFF0F] px-5 py-4 max-sm:w-[95%] md:w-[586px] xl:w-[586px]">
          <div className="w-full justify-center">
            ...
            <div className="mb-4">
              <h5 className="text-2xl font-medium text-[#F8F8F8]">Review Selling Order</h5>
            ...
            <form onSubmit={handleSubmit}>
              {!dataLoaded ? (
                ...
                <div className="mb-4 flex w-full flex-col gap-3 rounded-lg bg-[#120C20] p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <p className="text-sm text-[#8F8F8F]">You sell</p>
                    </div>
                    <div>
                      <p className="text-sm text-[#F8F8F8]">100.00 USDT</p>
                    </div>
                  </div>

                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <p className="text-sm text-[#8F8F8F]">You receive</p>
                    </div>
                    <div>
                      <p className="text-end text-sm text-[#ffffff]">₦15,000.00</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <p className="text-sm text-[#8F8F8F]">Fees</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <p className="text-end text-sm text-[#F8F8F8]">₦350.00</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <p className="text-end text-sm text-[#F8F8F8]">1 USDT =1,500.00</p>
                    </div>
                  </div>

                  <div className="flex w-full items-center gap-3 rounded-md bg-[#FFFFFF0D] p-4">
                    <p className="text-sm text-[#F8F8F8]">Receiving Account details</p>
                    <button
                      type="button"
                    ...
                    >
                      <img src="/bank.svg" /> Providus Bank • 134567890
                    </button>
                  </div>
                </div>
              )}
