...
const ReviewOrder: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setTimeout(() => router.push("/swap/confirming-swap"), 1000)
    } catch (error: any) {
      ...
      <div className="relative flex w-full flex-col items-center max-sm:mt-10 md:mt-0">
        <div className="flex h-auto rounded-lg bg-[#FFFFFF0F] px-5 py-4 max-sm:w-[95%] md:w-[586px] xl:w-[586px]">
          <div className="w-full justify-center">
            ...
            <div className="mb-4">
              <h5 className="text-center text-2xl font-medium text-[#F8F8F8]">Confirm swap</h5>
              <h5 className="mt-3 text-center text-2xl font-medium text-[#F8F8F8]">150,000.00 cNGN</h5>
            ...
            <div className="mb-4 flex w-full flex-col gap-3 rounded-lg bg-[#120C20] p-4">
              <div className="flex items-center justify-between">
                <p className="text-sm text-[#F8F8F8]">0xf13a6915f4c3eff63c3caa8bc532f59d1532d6f6</p>

                <CopyIcon />
              </div>
            </div>
            <div className="mb-3 flex w-full justify-between border-b border-[#646464] pb-3">
              <p className="text-sm text-[#F8F8F8]">Network</p>
              <div className="flex items-center gap-2">
                <p className="text-sm text-[#F8F8F8]">cNGN x Polygon</p>
                <img src="/polygon.png" className="w-5" />
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              {!dataLoaded ? (
                ...
                <div className="mb-4 flex w-full flex-col gap-3 rounded-lg bg-[#120C20] p-4">
                  <h5 className=" text-2xl font-medium text-[#F8F8F8]">Transaction Details</h5>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <p className="text-sm text-[#8F8F8F]">Amount to swap</p>
                      <InfoIcon />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <p className="text-sm text-[#8F8F8F]">YoSwap fee</p>
                      <InfoIcon />
                    </div>
                    <div>
                      <p className="text-end text-sm text-[#ffffff]">50 cNGN (1%)</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <p className="text-sm text-[#8F8F8F]">Network fees</p>
                      <InfoIcon />
                    </div>
                    <div className="flex items-center gap-2">
                      <p className="text-end text-sm text-[#F8F8F8]">350 cNGN</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <p className="text-sm text-[#8F8F8F]">You'll Receive</p>
                      <InfoIcon />
                    </div>
                    <div className="flex items-center gap-2">
                      <p className="text-end text-sm text-[#F8F8F8]">₦149,600.00</p>
                    </div>
                  </div>
                </div>
              )}
              <p className="mb-4 text-center text-sm text-[#f8f8f8]">
